...
A sacred-tech blue website and brand color kit with CSS variables, JSON tokens, Figma/Penpot files, LibreOffice palette support, and SVG previews.
...
Useful direction tags: Cobalt Palette, Blue UI, Sacred Tech, Premium UI, SaaS UI, Dashboard Design, AI Tools, Developer Tools.
...
Open the extracted `cobalt-chapel/` folder. The product docs are at the top level, generated assets are organized by mode, and all-mode references live in `combined/`.
