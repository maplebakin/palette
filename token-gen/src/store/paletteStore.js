...
const applyHistoryState = (state, payload) => ({
  ...
  accentHueShift: payload.accentHueShift,
  accentSaturationShift: payload.accentSaturationShift,
...
export const usePaletteStore = create((set, get) => ({
  ...
  setAccentHueShift: (value) => set((state) => withClearedVariants({ accentHueShift: resolveUpdater(value, state.accentHueShift) })),
  setAccentSaturationShift: (value) => set((state) => withClearedVariants({ accentSaturationShift: resolveUpdater(value, state.accentSaturationShift) })),
  ...
  setAccentHueInput: (value) => set((state) => ({ accentHueInput: resolveUpdater(value, state.accentHueInput) })),
  setAccentSaturationInput: (value) => set((state) => ({ accentSaturationInput: resolveUpdater(value, state.accentSaturationInput) })),
  ...
  applySavedPalette: (payload) => set((state) => {
    ...
    const accentHueShift = payload.accentHueShift ?? payload.fineTune?.accentHueShift ?? 0;
    const accentSaturationShift = payload.accentSaturationShift ?? payload.fineTune?.accentSaturationShift ?? 0;
    return {
      ...state,
      baseColor: sanitized,
      baseInput: sanitized,
      ...
      accentHueInput: accentHueShift,
      accentSaturationInput: accentSaturationShift,
